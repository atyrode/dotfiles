...
pkgs.runCommand "check-atyrode-tunnel"
  ...
  ''
    ...
    primary_key="$(awk '$2 == "primary" { print $4 }' ${../home/ssh-fleet-keys})"
    macbook_key="$(awk '$1 == "alex-macbook-air" { print $4 }' ${../home/ssh-fleet-keys})"
    other_key="$(awk '$1 == "unidentified-1" { print $4 }' ${../home/ssh-fleet-keys})"
    ...
    grep -q 'is not in home/ssh-fleet-keys' "$TMPDIR/unknown.err"
