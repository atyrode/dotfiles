...
class Readiness(unittest.TestCase):
    def setUp(self):
        ...
        self.manifest = {
            "schemaVersion": 1, "host": "fixture", "flake": ".",
            "generators": [{"name": "archive", "files": [{"name": "old", "path": str(self.target)}]}],
    ...
    def test_new_required_undeployed_file_is_named_until_generated(self):
        ...
        self.manifest["generators"][0]["files"].append({"name": "new-input", "path": None})
    ...
    def test_source_generation_does_not_hide_unplaced_new_output(self):
        ...
        self.manifest["generators"][0]["files"].append({"name": "new-output", "path": str(new)})
